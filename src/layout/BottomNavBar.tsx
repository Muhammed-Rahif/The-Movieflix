...
export default function BottomNavBar() {
  ...
  return (
    <div className="fixed bottom-0 left-1/2 right-0 z-50 flex w-full -translate-x-1/2 justify-between gap-2 rounded-t-3xl bg-accent p-4 pt-5 shadow-[0_0_24px_0_rgba(0,0,0,.7)] [-webkit-backface-visibility:hidden] sm:max-w-sm">
